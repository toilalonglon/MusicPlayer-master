...
import com.homie.musicplayer.Fragment.ArtistFragment;
...
//            Toast.makeText(this, "Permission granted", Toast.LENGTH_SHORT).show();
    ...
    public ArrayList<MusicFiles> getAllAudio(Context context){
        ...
        ArrayList<String> artists_Duplicate = new ArrayList<>();
        String order = null;
        ...
        if(cursor != null){
            while(cursor.moveToNext()){
                ...
                if(!artists_Duplicate.contains((artist)))
                {
                    artists.add(musicFiles);
                    artists_Duplicate.add(artist);
                }
            }
            cursor.close();
        }
